    ...
    <>
      <main className="flex flex-col gap-5  py-4 px-2 w-full h-screen items-center bgimage">
        <section className="flex justify-evenly gap-4">
          <button
            className="bg-green-500 px-2 py-2 rounded text-1xl font-bold text-slate-900 shadow-[0px_0px_5px_black] hover:scale-[1.1]"
          ...
          >
           ...
           {buttons &&  <button
              className="bg-green-500 px-2 py-2 rounded text-1xl font-bold text-slate-900 shadow-[0px_0px_5px_black] hover:scale-[1.1] whitespace-nowrap"
